            ...
            <div className="container mx-auto px-4 py-8 mt-16">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        {/* Horizontal scrollable random practice categories */}
                        <div className="relative">
                            <div
                                className="flex gap-4 overflow-x-auto flex-nowrap hide-scrollbar pb-2"
                                style={{ WebkitOverflowScrolling: 'touch' }}
                            >
                                {/* All Categories Option */}
                                <div 
                                    className="min-w-[220px] bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow border-2 border-transparent hover:border-[#FF6B8B] flex-shrink-0"
                                ...
                                {categories && categories.length > 0 ? (
                                    ...
                                    <div className="bg-white rounded-xl shadow-lg p-4 min-w-[220px] flex-shrink-0">
                                        <p className="text-gray-600">No categories available.</p>
                                    </div>
                                )}
                            </div>
                            {/* Optional: visual cue for scroll */}
                            <div className="pointer-events-none absolute right-0 top-0 h-full flex items-center pr-2 z-10">
                                <div className="bg-gradient-to-l from-white/90 to-transparent pl-2">
